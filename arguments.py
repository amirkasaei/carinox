...
def parse_args():
    ...
    parser.add_argument(
        "--eval_model_weighting",
        type=float,
        help="Weighting for evaluation model",
        default=1.0,
    )
    ...
    parser.add_argument(
        "--grad_clip", type=float, help="Gradient clipping", default=0.1 # TODO
    )
    ...
    parser.add_argument(
        "--hps_weighting", type=float, help="Weighting for HPS", default= 1.0
    )
    parser.add_argument(
        "--disable_imagereward",
        default=True,
    ...
    parser.add_argument(
        "--clip_weighting", type=float, help="Weighting for CLIP", default=1 # TODO 
    )
    parser.add_argument(
        "--disable_pickscore",
        default=True,
    ...
    parser.add_argument(
        ...
        default=True,
        action="store_false",
        dest="enable_vqa_score",
    )
    parser.add_argument(
        "--vqa_score_weighting",
        type=float,
        help="Weighting for VQAScore",
        default=1.0,
    )
    parser.add_argument(
        "--disable_da_score",
        default=True,
        action="store_false",
        dest="enable_da_score",
    )
    parser.add_argument(
        "--da_score_weighting",
        type=float,
        help="Weighting for DAScore",
        default=1.0,
    )
    ...
    parser.add_argument(
        ...
        default=True,
        action="store_false",
        dest="enable_dsg_score",
    )
    parser.add_argument(
        "--dsg_score_weighting",
        type=float,
        help="Weighting for DSGScore",
        default=5.0,
    )
